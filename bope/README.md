# BOPE War Room — capa exportable

Esta carpeta **no reemplaza** `.claude/` ni `.Codex/`: es el contrato listo para **Multica**, automatización y lectura en GitHub.
...
Workspace lógico Multica: `bope-war-room` (campo en `roster.json`).
