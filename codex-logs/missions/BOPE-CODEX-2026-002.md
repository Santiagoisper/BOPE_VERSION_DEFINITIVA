...
Normalizacion del arranque local de Codex y alta de SICARIO | Locura
...
Codex ahora arranca con bootstrap local al repo y `SICARIO | Locura` forma parte de la capa operativa visible.

## Aprendizaje

La doctrina madre sirve como fuente de resincronizacion, no como bootstrap obligatorio de cada sesion local.
