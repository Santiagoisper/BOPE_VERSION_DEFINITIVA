...
| `JOHN RAMBO` | John James Rambo | `Sergeant Major of the Marine Corps` | Mando operativo | Activo | `8` | `Navy Cross` | [JOHN-JAMES-RAMBO.md](personnel/JOHN-JAMES-RAMBO.md) |
...
| `WINSTON SCRIBE` | Winston Alastair MacLeod | `Warrant Officer` | Cronista | Activo | `7` | `Commendation Medal` | [WINSTON-ALASTAIR-MACLEOD.md](personnel/WINSTON-ALASTAIR-MACLEOD.md) |
