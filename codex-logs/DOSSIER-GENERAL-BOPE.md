...
- las operaciones visibles salen de `codex-logs/TABLERO-DE-RECORDS.md`
...
| `JOHN RAMBO` | John James Rambo | `Sergeant Major of the Marine Corps` | Mando operativo | Activo | `7` | `Navy Cross` | [JOHN-JAMES-RAMBO.md](personnel/JOHN-JAMES-RAMBO.md) |
...
| `WINSTON SCRIBE` | Winston Alastair MacLeod | `Warrant Officer` | Cronista | Activo | `6` | `Commendation Medal` | [WINSTON-ALASTAIR-MACLEOD.md](personnel/WINSTON-ALASTAIR-MACLEOD.md) |
...
| `SICARIO LOCO` | Mateo Esteban Salazar | `Special Operations Tier 1` | Operativo Especial | Activo | `2` | `Purple Heart` | [MATEO-ESTEBAN-SALAZAR.md](personnel/MATEO-ESTEBAN-SALAZAR.md) |
...
4. `codex-logs/TABLERO-DE-RECORDS.md` si aplica
5. `codex-logs/FICHAS-OPERATIVAS-BOPE.md`
6. `codex-logs/DOSSIER-GENERAL-BOPE.md`
7. los legajos personales afectados en `codex-logs/personnel/`
