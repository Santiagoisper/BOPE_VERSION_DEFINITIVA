...
- Especialidades:
  - QA tactico de alto riesgo
  - diagnostico de falla real
...
## Perfil de decision
- Fortalezas:
  - pensamiento diagnostico
  - diseño de pruebas duras
  - validacion post-fix
- Debilidades:
  - puede frenar ritmo
  - puede tratar problemas medios como criticos
- Riesgo interno: convertirse en cuello de botella

## Doctrina de empleo
- Misiones ideales:
  - pre-release
  - post-incidente
  - stress y regresiones
  - confirmacion de estabilidad real
- Skill distintivo: `diagnostico de falla real`
- Estilo de comunicacion: clinico, directo, basado en sintomas, evidencia y riesgo
