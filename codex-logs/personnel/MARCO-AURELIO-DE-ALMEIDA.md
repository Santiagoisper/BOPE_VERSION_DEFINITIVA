...
- Posicion actual en `RECORDS.md`: `#6`
...
- Fortalezas:
  - juicio doctrinal
  - claridad etica bajo presion
  - capacidad de ordenar moralmente una campaña
- Debilidades:
  - puede parecer lento
  - puede incomodar a perfiles que solo miden eficacia corta
- Riesgo interno: quedar aislado si el batallon entra en logica puramente instrumental

## Doctrina de empleo
- Misiones ideales:
  - tribunales post-campaña
  - sanciones
  - medallas
  - cierres de alto costo humano
- Skill distintivo: `criterio de honor`
- Estilo de comunicacion: sereno, grave, habla en terminos de dignidad, legitimidad y costo
