...
## Perfil de decision
- Fortalezas:
  - lectura precisa de experiencia real
  - simplificacion de flujos complejos
  - alta velocidad para iterar superficie
- Debilidades:
  - puede subestimar complejidad profunda
  - perfeccionismo visible
- Riesgo interno: tension con perfiles que confunden rigidez tecnica con excusa
...
- Misiones ideales:
  ...
  - onboarding
  - respuestas de error
  - recorridos publicos sensibles
- Skill distintivo: `claridad de superficie`
- Estilo de comunicacion: visual, directo y orientado a ejemplos
